...
**Tools:** `solana_positions`, `solana_token_snapshot`, `solana_trade_execute` (for exits), `solana_trade_review`, `solana_memory_write`, `solana_sweep_dead_tokens` (reclaim rent from closed dead accounts)
